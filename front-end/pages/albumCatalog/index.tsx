    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-gradient-to-b from-blue-50 via-blue-100 to-blue-200 p-8">
                <h1 className="text-4xl font-bold text-center text-blue-600 mb-8">{t('albumcatalog.albumCatalogTitle')}</h1>
                        ...
                        <table className="min-w-full table-auto">
                            <thead>
                                <tr className="bg-blue-500 text-white">
                                    <th className="px-4 py-2 text-left">{t('albumcatalog.tableAlbumTitle')}</th>
                                    <th className="px-4 py-2 text-left">{t('albumcatalog.tableSongsCount')}</th>
                                </tr>
                            </thead>
                            <tbody>
                                {albums.map((album) => (
                ...
                {selectedAlbum && (
                    <div className="mt-8 bg-white p-6 rounded-lg shadow-lg max-w-6xl mx-auto">
                        <h3 className="text-xl font-semibold mb-4">{t('albumcatalog.albumSongs')}</h3>
                        <ul>
